...
const Body7 = () => {
  ...
  return (
    ...
    <div className="body7">
        ...
        <p>FUNDING STATUS</p>
        <h5>₹1,17,05,000 of ₹1,17,05,000 funded</h5>
        <hr />
        <div className="details">
            <div className="detail1">
                <h2><img width="20" height="20" src="https://img.icons8.com/ios/50/building.png" alt="building"/> Builder's Profile</h2>
                <ol>
                    <li>Over 10 years of experience in the industry.</li>
                    <li>2 million+ sq.ft. developed and in development.</li>
                    <li>Received CRISIL 5 star rating for its ultra-luxury architecture, construction guarantee, project legal <br /> qualities, and financial quality</li>
                    <li>www.hebronproperties.com</li>
                </ol>
            </div>
            <div className="detail2">
            <h2><img width="20" height="20" src="https://img.icons8.com/ios/50/sparkling.png" alt="sparkling"/> Benefits of this location</h2>
                <ol>
